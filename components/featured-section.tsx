            ...
            <div className="inline-block bg-[#0a0a0a] border border-[#1a1a1a] rounded-sm p-12">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Button
                  ...
                  asChild
                >
                  <a href={`https://wa.me/57${settings?.whatsappNumber || "3043598195"}`} target="_blank" rel="noopener noreferrer" onClick={(e) => handleWhatsAppClick(e, `https://wa.me/57${settings?.whatsappNumber || "3043598195"}`)}>
