              ...
              <div className="bg-gradient-to-r from-[#25D366]/10 to-[#25D366]/5 border border-[#25D366]/30 rounded-sm p-6">
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <a href={`https://wa.me/57${settings?.whatsappNumber || "3025459865"}`} target="_blank" rel="noopener noreferrer" onClick={(e) => trackContactInteraction(e, `https://wa.me/57${settings?.whatsappNumber || "3025459865"}`, "Contact Section WhatsApp CTA")}>
