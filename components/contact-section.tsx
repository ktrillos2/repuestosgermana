...
import { handleConversionClick, GA_CONVERSION_ID } from "@/lib/conversion-utils"
                    ...
                    <div className="bg-[#111111] border border-[#1a1a1a] rounded-sm p-6 hover:border-[#0066B1]/50 transition-all duration-300 group hover:scale-105 h-full">
                      {info.href ? (
                        <a
                          href={info.href}
                          className="block"
                          onClick={(e) => handleConversionClick(e, info.href || "", `Contact Section ${info.title}`)}
                        >
              ...
              <div className="bg-gradient-to-r from-[#25D366]/10 to-[#25D366]/5 border border-[#25D366]/30 rounded-sm p-6">
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <a href={`https://wa.me/57${settings?.whatsappNumber || "3025459865"}`} target="_blank" rel="noopener noreferrer" onClick={(e) => handleConversionClick(e, `https://wa.me/57${settings?.whatsappNumber || "3025459865"}`, "Contact Section WhatsApp CTA")}>
